...
public class BaseLogicMonitor extends BuildingMonitor{
    ...
    /**
     * Убран из списка добавляемых мониторов апстримом в 1.16.0 ("fix: removed memory monitor") -
     * класс оставлен только затем, чтобы уже сохранённые у игроков мониторы этого типа
     * десериализовались без ошибки, тело build/validate закомментировано как у апстрима.
     */
    @Deprecated
